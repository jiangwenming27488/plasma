...
public:
  ...
  /// \param output_memory_quota The memory quota in bytes for objects created
  /// by
  ///        this client.
  ...
  /// Create and seal multiple objects in the object store. This is an
  /// optimization of CreateAndSeal to eliminate the cost of IPC per object.
  ///
  ...
  /// Otherwise, it is a no operation.
  ///
  ...
  /// Delete a list of objects from the object store. This currently assumes
  /// that the object is present, has been sealed and not used by another
  /// client. Otherwise, it is a no operation.
  ///
  ...
  /// Receive next object notification for this client if Subscribe has been
  /// called.
  ///
  /// \param fd The file descriptor we are reading the notification from.
  /// \param object_id Out parameter, the object_id of the object that was
  /// sealed. \param data_size Out parameter, the data size of the object that
  /// was sealed. \param metadata_size Out parameter, the metadata size of the
  /// object that was sealed. \return The return status.
