...
Status PlasmaReceive(int sock, MessageType message_type,
...
Status ReadSetOptionsRequest(const uint8_t *data, size_t size,
...
Status SendCreateAndSealRequest(int sock, const ObjectID &object_id,
                                bool evict_if_full, const std::string &data,
                                const std::string &metadata,
                                unsigned char *digest);

Status ReadCreateAndSealRequest(const uint8_t *data, size_t size,
                                ObjectID *object_id, bool *evict_if_full,
                                std::string *object_data, std::string *metadata,
                                std::string *digest);

Status SendCreateAndSealBatchRequest(int sock,
...
Status ReadGetRequest(const uint8_t *data, size_t size,
...
Status ReadReleaseRequest(const uint8_t *data, size_t size,
                          ObjectID *object_id);
...
Status ReadContainsRequest(const uint8_t *data, size_t size,
                           ObjectID *object_id);
...
Status ReadConnectReply(const uint8_t *data, size_t size,
...
Status SendDataRequest(int sock, ObjectID object_id, const char *address,
                       int port);
