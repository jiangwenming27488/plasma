...
struct ObjectInfo FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  int64_t data_size() const { return GetField<int64_t>(VT_DATA_SIZE, 0); }
  int64_t metadata_size() const {
    return GetField<int64_t>(VT_METADATA_SIZE, 0);
  }
  int32_t ref_count() const { return GetField<int32_t>(VT_REF_COUNT, 0); }
  int64_t create_time() const { return GetField<int64_t>(VT_CREATE_TIME, 0); }
  ...
  bool is_deletion() const { return GetField<uint8_t>(VT_IS_DELETION, 0) != 0; }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_OBJECT_ID) &&
  ...
  void
  UnPackTo(ObjectInfoT *_o,
           const flatbuffers::resolver_function_t *_resolver = nullptr) const;
  static flatbuffers::Offset<ObjectInfo>
  Pack(flatbuffers::FlatBufferBuilder &_fbb, const ObjectInfoT *_o,
...
struct ObjectInfoBuilder {
  ...
  void add_construct_duration(int64_t construct_duration) {
    fbb_.AddElement<int64_t>(ObjectInfo::VT_CONSTRUCT_DURATION,
  ...
  void add_is_deletion(bool is_deletion) {
    fbb_.AddElement<uint8_t>(ObjectInfo::VT_IS_DELETION,
                             static_cast<uint8_t>(is_deletion), 0);
  }
...
inline flatbuffers::Offset<ObjectInfo>
CreateObjectInfo(flatbuffers::FlatBufferBuilder &_fbb,
                 flatbuffers::Offset<flatbuffers::String> object_id = 0,
                 int64_t data_size = 0, int64_t metadata_size = 0,
                 int32_t ref_count = 0, int64_t create_time = 0,
                 int64_t construct_duration = 0,
...
inline flatbuffers::Offset<ObjectInfo>
CreateObjectInfoDirect(flatbuffers::FlatBufferBuilder &_fbb,
                       const char *object_id = nullptr, int64_t data_size = 0,
                       int64_t metadata_size = 0, int32_t ref_count = 0,
                       int64_t create_time = 0, int64_t construct_duration = 0,
                       const char *digest = nullptr, bool is_deletion = false) {
  ...
  return plasma::flatbuf::CreateObjectInfo(
      _fbb, object_id__, data_size, metadata_size, ref_count, create_time,
      construct_duration, digest__, is_deletion);
}

flatbuffers::Offset<ObjectInfo>
CreateObjectInfo(flatbuffers::FlatBufferBuilder &_fbb, const ObjectInfoT *_o,
                 const flatbuffers::rehasher_function_t *_rehasher = nullptr);

inline ObjectInfoT *
ObjectInfo::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
...
inline void
ObjectInfo::UnPackTo(ObjectInfoT *_o,
  ...
  {
    auto _e = construct_duration();
    _o->construct_duration = _e;
  }
  {
    auto _e = digest();
    if (_e)
...
inline flatbuffers::Offset<ObjectInfo>
ObjectInfo::Pack(flatbuffers::FlatBufferBuilder &_fbb, const ObjectInfoT *_o,
...
CreateObjectInfo(flatbuffers::FlatBufferBuilder &_fbb, const ObjectInfoT *_o,
  ...
  struct _VectorArgs {
    ...
    const ObjectInfoT *__o;
    const flatbuffers::rehasher_function_t *__rehasher;
  } _va = {&_fbb, _o, _rehasher};
  (void)_va;
  auto _object_id =
      _o->object_id.empty() ? 0 : _fbb.CreateString(_o->object_id);
  ...
  return plasma::flatbuf::CreateObjectInfo(
      _fbb, _object_id, _data_size, _metadata_size, _ref_count, _create_time,
      _construct_duration, _digest, _is_deletion);
}
